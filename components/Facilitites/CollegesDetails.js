...
import { getCollege, getGalleryCategory } from "../../Util/auth";
      ...
      <Pressable style={styles.itemContainer2}>
        ...
        >
          <Image
            ...
            source={{
              uri:
                "http://134.209.222.136/khel_sathi/files/colleges/" +
                item.image,
            }}
          />
          <View
...
const CollegesDetials = ({ navigation, state, data, image }) => {
...
export default CollegesDetials;
